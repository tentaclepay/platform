/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 7ece46f0552493c9adb995f9177365f7)
// Runtime types generated with workerd@1.20260521.1 2026-04-15 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	SUI_MAINNET_GRPC_URL: string;
	SUI_TESTNET_GRPC_URL: string;
	SUI_DEVNET_GRPC_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUI_MAINNET_GRPC_URL" | "SUI_TESTNET_GRPC_URL" | "SUI_DEVNET_GRPC_URL" | "FACILITATOR_PRIVATE_KEY">> {}
}
